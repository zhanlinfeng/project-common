...
public class RedisUtil {
	 ...
	 * TODO
	 */
	public boolean writeToSet(String key, String value) {
	 ...
	 * TODO
	 */
	public boolean removeFromSetByValue(String key, String value) {
		SetOperations<String, String> set = redisTemplate.opsForSet();
		try {
	...
	public Set<String> getAllFromSet(String key) {
		SetOperations<String, String> set = redisTemplate.opsForSet();
		if(set.getOperations().hasKey(key) && set.size(key) > 0) {
			Set<String> result =  set.members(key);
			return result;
		}
		return new HashSet<>();
	}
