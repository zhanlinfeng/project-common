 ...
 **/
public class MissingServletBodyParamterException extends ServletRequestBindingException {
     ...
     */
    public MissingServletBodyParamterException(String parameterName, String parameterType) {
        super("");
